...
Idents <- c("Mesenchymal Cells","Venular ECs","Basal Keratinocytes","Venular ECs","Mesenchymal Cells","T Cells","Mesenchymal Cells","Corneum Keratinocytes","Mesenchymal Cells","Myeloid cells","Corneum Keratinocytes","Mesenchymal Cells","Mesenchymal Cells","Mesenchymal Cells","T Cells","Spinous Keratinocytes","T Cells","Mesenchymal Cells","Venular ECs","Venular ECs","Venular ECs","Basal Keratinocytes","Mesenchymal Cells","Mesenchymal Cells","Myeloid cells","Lynfatic ECs","Granular Keratinocytes","Mesenchymal Cells","Mesenchymal Cells","Venular ECs","Mast Cells","Schwann Cells","Venular ECs","Mesenchymal Cells","Basal Keratinocytes")
...
tiff(filename = out,units="in",width = 14,height = 7,res=300)
DimPlot(ps_filtr, reduction = "umap",pt.size=0.7,label = T) + 
...
tiff(filename = out,units="in",width = 14,height = 7,res=300)
DimPlot(ps_filtr, reduction = "umap",pt.size=0.7,label = T,cells = ps_filtr@meta.data$cell == c("Ctrl")) + ggtitle("Ctrl")  +  theme(plot.title = element_text(hjust = 0.55))
dev.off()
#Psor:
out <- paste("images/",id,"_Clusters_UMAP_Psor.png",sep="")
tiff(filename = out,units="in",width = 14,height = 7,res=300)
...
FeaturePlot(ps_filtr,features="PKM",split.by = "cell", cols = c("grey","brown4"),label = T, pt.size = 1)  
dev.off() 
out <- paste("images\\",id,"_S100A9_Feature.png",sep="")
png(filename = out,units="in",width = 17,height = 7,res=300)
FeaturePlot(ps_filtr,features="S100A9",split.by = "cell", cols = c("grey","brown4") , label = T, pt.size = 1)
dev.off() 
out <- paste("images\\",id,"_LCN2_Feature.png",sep="")
png(filename = out,units="in",width = 17,height = 7,res=300)
FeaturePlot(ps_filtr,features="LCN2",split.by = "cell", cols = c("grey","brown4") , label = T, pt.size = 1)
dev.off() 
out <- paste("images\\",id,"_KRT14_Feature.png",sep="")
png(filename = out,units="in",width = 17,height = 7,res=300)
FeaturePlot(ps_filtr,features="KRT14",split.by = "cell", cols = c("grey","brown4") , label = T, pt.size = 1)
dev.off() 
out <- paste("images\\",id,"_KRT17_Feature.png",sep="")
png(filename = out,units="in",width = 17,height = 7,res=300)
FeaturePlot(ps_filtr,features="KRT17",split.by = "cell", cols = c("grey","brown4") , label = T, pt.size = 1)
dev.off() 
out <- paste("images\\",id,"_PKM_Feature_PSOR.png",sep="")
png(filename = out,units="in",width = 12,height = 7,res=300)
FeaturePlot(obj.list[2]$Psor,features="PKM", cols = c("grey","brown4"),label = T, pt.size = 1)  +
        ggtitle("Psor PKM")  +  theme(plot.title = element_text(hjust = 0.5))
dev.off()
out <- paste("images\\",id,"_PKM_Feature_CTRL.png",sep="")
png(filename = out,units="in",width = 12,height = 7,res=300)
FeaturePlot(obj.list[1]$Ctrl,features="PKM", cols = c("grey","brown4"),label = T, pt.size = 1)  +
        ggtitle("Ctrl PKM")  +  theme(plot.title = element_text(hjust = 0.5))
dev.off()
?FeaturePlot

#FeaturePlot2:
out <- paste("images\\",id,"_PKM_FeatureT.png",sep="")
png(filename = out,units="in",width = 17,height = 7,res=300)
FeaturePlot(ps_filtr,features="PKM", cols= c("grey","brown4") , label = T, pt.size = 1)
dev.off() 
out <- paste("images\\",id,"_S100A9_FeatureT.png",sep="")
png(filename = out,units="in",width = 17,height = 7,res=300)
FeaturePlot(ps_filtr,features="S100A9", cols = c("grey","brown4") , label = T, pt.size = 1)
dev.off() 
out <- paste("images\\",id,"_LCN2_FeatureT.png",sep="")
png(filename = out,units="in",width = 17,height = 7,res=300)
FeaturePlot(ps_filtr,features="LCN2", cols = c("grey","brown4") , label = T, pt.size = 1)
dev.off() 
out <- paste("images\\",id,"_KRT14_FeatureT.png",sep="")
png(filename = out,units="in",width = 17,height = 7,res=300)
FeaturePlot(ps_filtr,features="KRT14", cols = c("grey","brown4") , label = T, pt.size = 1)
dev.off() 
out <- paste("images\\",id,"_KRT17_FeatureT.png",sep="")
png(filename = out,units="in",width = 17,height = 7,res=300)
